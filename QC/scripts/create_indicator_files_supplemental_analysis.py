...
def get_indicators(cache_directory, run_description, years = [2018,2020,2050], base_year=2018):
#def get_indicators(cache_directory, run_description, years = [2014], base_year=2014):
...
def get_end_year_indicators(cache_directory, run_description, years = [2018,2050], base_year=2018):
     ...
     indicators=[
         DatasetTable(
             ...
             exclude_condition = 'building.year_built<2019',
             ),
         ...
         DatasetTable(
             ...
             attributes = [
                 ...
                 'parcel.plan_type_id',
                 'residential_units_base = parcel.aggregate(building.residential_units * (building.year_built < 2019))'
             ],
             ),
         ]
     return indicators
