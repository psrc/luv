...
## County Level Control indicators  - added 4.17.2018
       ...
       Table(
        ...
        Table(
            attribute = 'residential_units=county.aggregate(urbansim_parcel.building.residential_units, intermediates=[parcel, target])',
            dataset_name = 'county',
            source_data = source_data,
            ),	   
...
# Target Geography indicators  
       ...
       Table(
        ...
        Table(
            attribute = 'residential_units=target.aggregate(urbansim_parcel.building.residential_units, intermediates=[parcel])',
            dataset_name = 'target',
            source_data = source_data,
            ),	   
...
# Control Geography indicators  
       ...
       Table(
        ...
        Table(
            attribute = 'residential_units=control.aggregate(urbansim_parcel.building.residential_units, intermediates=[parcel])',
            dataset_name = 'control',
            source_data = source_data,
            ),	
...
## Control_hct Geography indicators  
       ...
       Table(
        ...
        Table(
            attribute = 'residential_units=control_hct.aggregate(urbansim_parcel.building.residential_units, intermediates=[parcel])',
            dataset_name = 'control_hct',
            source_data = source_data,
            ),	
    ...
    ## Tract-City indicators
     ...
     ## ============================
      ...
      ##============================
        ...
        Table(
            attribute = 'population=census_block.aggregate(urbansim_parcel.parcel.population)',
            dataset_name = 'census_block',
            source_data = source_data,
            ),
        Table(
            attribute = 'employment=census_block.aggregate(urbansim_parcel.parcel.number_of_jobs)',
            dataset_name = 'census_block',
            source_data = source_data,
            ),
        # Table(
