...
def get_indicators(cache_directory, run_description, years = [2023,2050], base_year=2023):
    ...
    indicators=[		
        ...
        attributes = [
            'mean_income = safe_array_divide(faz.aggregate(household.income * (household.income > 0), intermediates=[building, parcel, zone]), faz.aggregate((household.household_id > 0) * (household.income > 0), intermediates=[building,parcel,zone]))',
        ...
        DatasetTable(
            ...
            name =  'households_characteristics',
        attributes = [
            'mean_income = safe_array_divide(zone.aggregate(household.income * (household.income > 0), intermediates=[building, parcel]), zone.aggregate((household.household_id > 0) * (household.income > 0), intermediates=[building,parcel]))',
        ...
        DatasetTable(
            ...
            name =  'households_characteristics',
        attributes = [
            'mean_income = safe_array_divide(city.aggregate(household.income * (household.income > 0), intermediates=[building, parcel]), city.aggregate((household.household_id > 0) * (household.income > 0), intermediates=[building,parcel]))',
        ...
        DatasetTable(
            ...
            name =  'households_characteristics',
        attributes = [
            'mean_income = safe_array_divide(control.aggregate(household.income * (household.income > 0), intermediates=[building, parcel]), control.aggregate((household.household_id > 0) * (household.income > 0), intermediates=[building,parcel]))',
